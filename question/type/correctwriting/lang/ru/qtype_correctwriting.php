...
$string['systemmayfreeze'] = 'Система может зависнуть при обработке опечаток, если ответ содержит более 6 очень похожих слов. Выключите контроль опечаток или опустите порог ошибки в символах!';
...
// privacy
$string['privacy:metadata'] = '\'Пишем правильно\' не хранит пользовательские данные.';
